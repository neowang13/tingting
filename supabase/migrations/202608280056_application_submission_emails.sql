-- Durable, retryable Admin emails for submitted rental applications.
-- The queue payload stores identifiers and routing only. Form details and
-- attachment bytes stay in the application tables and private storage.
